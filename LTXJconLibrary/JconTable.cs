...
/*
 *   Title: Jcon Table 
 *   Putpose: Collection of Jcon path with System Board
 *   Version: 1
...
{
    public class JconTable
    {
        protected static string[,] j100 = new string[4, 61]
       {
            {
        ...
        protected static string[,] j101 = new string[4, 61]
        {
           {
        ...
        protected static string[,] j102 = new string[4, 61]
        {
            {
        ...
        protected static string[,] j203 = new string[4, 26]
        {
            {
